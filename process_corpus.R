...
setwd("C:/Users/deuscoli/Desktop/Coursera_DataScience/10_Capstone/submit")
...
sample_size <- 0.25 # Subsamle to 25%, this worked in memory
sample_size <- 0.5 # works
...
corpus.bigram.counts.sorted.pruned <- corpus.bigram.counts.sorted[corpus.bigram.counts.sorted$Freq>=2, ]
...
corpus.unigram.counts.sorted.pruned <- corpus.unigram.counts.sorted[corpus.unigram.counts.sorted$Freq>=2, ]
